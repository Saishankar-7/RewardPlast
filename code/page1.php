...
<body>
    ...
    <div class="sidebar">
        ...
        <li><a href="home.html"><i class="fas fa-home"></i>HOME</a></li>
            <li><a href="userprofile.php"><i class="fas fa-stream"></i> PROFILE</a></li>
            <li><a href="userpayments.php"><i class="fas fa-link"></i>MY PAYMENTS</a></li>
            <li><a href="leaderboard.php"><i class="fas fa-qrcode"></i>LEADER BOARD</a></li>
